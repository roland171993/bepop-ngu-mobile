...
import 'package:bepop_ngu/data/models/chatMessagesResponse.dart';
import 'package:bepop_ngu/data/models/chatUserRole.dart';
import 'package:bepop_ngu/data/models/chatUsersResponse.dart';
import 'package:bepop_ngu/data/models/userChatHistory.dart';
...
class ChatRepository {
  ...
  Future<UserChatHistory> getUserChatHistory({
    ...
    try {
      ...
      print("this is the chat server error $e");
      print("this is the chat server error $st");
      throw ApiException(e.toString());
    }
  }
