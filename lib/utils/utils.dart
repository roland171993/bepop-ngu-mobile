...
import 'package:bepop_ngu/ui/widgets/downloadFileBottomsheetContainer.dart';
import 'package:bepop_ngu/ui/widgets/errorMessageOverlayContainer.dart';
    ...
    showBottomSheet(
      ...
      if (result != null) {
        if (result['error']) {
          ...
          print("This is the result ${result['error']}");
          showCustomSnackBar(
            context: context,
