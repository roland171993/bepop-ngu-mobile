...
import 'package:bepop_ngu/ui/screens/playVideo/widgets/videoControlsContainer.dart';
import 'package:bepop_ngu/ui/screens/playVideo/widgets/playPauseButton.dart';
...
class _PlayVideoScreenState extends State<PlayVideoScreen>
  ...
  void initState() {
    ...
    _setSystemUIOverlayStyle(Orientation.portrait);
  ...
  void _setSystemUIOverlayStyle(Orientation orientation) {
  ...
  @override
  void dispose() {
    // Restore system UI overlays when disposing
    SystemChrome.setEnabledSystemUIMode(SystemUiMode.edgeToEdge);
    SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(
      statusBarColor: Colors.transparent,
      statusBarIconBrightness: Brightness.dark,
    ...
    // Ensure portrait orientation when leaving
  ...
  Widget build(BuildContext context) {
    return OrientationBuilder(
      builder: (context, orientation) {
        // Update system UI overlay style when orientation changes
        WidgetsBinding.instance.addPostFrameCallback((_) {
          _setSystemUIOverlayStyle(orientation);
        });
        return PopScope(
          ...
          onPopInvokedWithResult: (dynamic, _) {
            if (orientation == Orientation.landscape) {
              ...
              // Restore system UI when popping in portrait mode
              SystemChrome.setEnabledSystemUIMode(SystemUiMode.edgeToEdge);
              SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(
                statusBarColor: Colors.transparent,
                statusBarIconBrightness: Brightness.dark,
